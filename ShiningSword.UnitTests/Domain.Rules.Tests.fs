...
let Tests = testLabel "Domain" <| testList "Rules" [
    ...
    testCase "Spot check defense choice" <| fun () ->
        ...
        let chooseDefense dodge parry block retreat =
            let combatant = create dodge parry block retreat
            chooseDefense combatant
        verify <@ chooseDefense 10 10 10 true = (10, { defense = Dodge; targetRetreated = false })  @>
        ...
        verify <@ chooseDefense 10 10 10 false = (13, { defense = Dodge; targetRetreated = false })  @>
        verify <@ chooseDefense 10 13 9 false = (14, { defense = Parry; targetRetreated = false }) @>
        verify <@ chooseDefense 10 9 14 false = (15, { defense = Block; targetRetreated = false }) @>
        verify <@ chooseDefenseUnderConditions 10 10 10 false 7 [] = (8, { defense = Dodge; targetRetreated = false })  @>
        verify <@ chooseDefenseUnderConditions 10 10 10 false 0 [Stunned] = (6, { defense = Dodge; targetRetreated = false })  @>
